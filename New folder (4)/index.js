...
document.getElementById("btn").addEventListener("click",function(){
  a.sort(function(a,b){
    ...
    for (let i=0;i<a.length;i++){
     document.getElementById("one").innerText=a[i].price
     document.getElementById("two").innerText=a[i].title
console.log(a[i].price ,a[i].title)    ;
  }
...
document.getElementById("btn2").addEventListener("click",function(){
  a.sort(function(a,b){
    ...
    for (let i=0;i<a.length;i++){
     document.getElementById("one1").innerText=a[i].price
     document.getElementById("two2").innerText=a[i].title
console.log(a[i].price ,a[i].title)    ;
  }
